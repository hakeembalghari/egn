...
{
  echo "<script>window.location='login/failed?title=Error!&r=Please login first to access this page'</script>";exit;
}
...
<form class="form-horizontal" method="POST" action="registeru.php" style="margin-left: -15px;padding-top:20px;" id="regForm">
  <div class="control-group">
    ...
    <div class="controls">
      <input type="text" id="inputEmail" name="username" placeholder="Name" value="<?=$Record['username'];?>" required>
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputEmail">Old Password</label>
    <div class="controls">
      <input type="password" id="inputEmailOld" name="OldPassword" placeholder="Old Password" required> 
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputEmail">New Password</label>
    <div class="controls">
      <input type="password" id="inputEmail" name="password" placeholder="New Password" required> (Password shouldn't be same as username)
    </div>
  </div>
  <div class="control-group">
  ...
  <div class="control-group">
    ...
    <div class="controls">
      <input type="email" name="email" id="inputEmail" placeholder="Email" value="<?=$Record['email'];?>" required>
    </div>
  </div>
  <div class="control-group">
  ...
  <p style="font-size: 18px;padding-top: 6px;padding-left:25px; padding-botttom: 10px;">Personal Information</p>
  
  <div class="control-group">
    <label class="control-label" for="inputEmail">Full Name</label>
    <div class="controls">
      <input type="text" name="fullname" for="inputEmail" placeholder="Full Name" required />
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="inputEmail">Twitch TV Username</label>
    <div class="controls">
      <input type="text" name="twitch_username" for="inputEmail" placeholder="Twich Tv Username"/>
    </div>
  </div>
