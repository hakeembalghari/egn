...
if ($_REQUEST['do'] == 'head')
{
	...
	<tr align="center" valign="top">
		<td style="text-align:<?php echo vB_Template_Runtime::fetchStyleVar('left'); ?>"><a href="http://www.vbulletin.com/" target="_blank"><b><?php echo $vbphrase['admin_control_panel']; ?></b> (vBulletin <?php echo ADMIN_VERSION_VBULLETIN . print_form_middle('VBFA489C88'); ?>)<?php echo iif(is_demo_mode(), ' <b>DEMO MODE</b>'); ?></a></td>
	...
	<script type="text/javascript" src="<?php echo $versionhost; ?>/version.js?v=<?php echo SIMPLE_VERSION; ?>&amp;id=VBFA489C88&amp;pid=vbforum_4"></script>
...
if ($_REQUEST['do'] == 'nav')
{
	...
	echo "\n<div>";
	?><img src="../cpstyles/<?php echo $vbulletin->options['cpstylefolder']; ?>/cp_logo.gif" title="<?php echo $vbphrase['admin_control_panel']; ?>" alt="" border="0" hspace="4" <?php $df = print_form_middle("VBFA489C88"); ?> vspace="4" /><?php
