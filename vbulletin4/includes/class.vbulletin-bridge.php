<?php
define('FORUMPATH', '/home/elect150/public_html/beta/vbulletin4'); // path to your forum
//define('FORUMPATH', 'D:/Development/xampp/htdocs/beta/vbulletin4'); // path to your forum
...
//print_r($this->userdm->errors);exit;      
...
//---------------------------------------------------------------------
   public function login($vbuser,$acceptgroups=false)
   {
	  ...
	  //print_r($this->vbulletin->userinfo);exit;
	  //Verify login via VB
