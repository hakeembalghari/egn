	...
	<div class="mbox">
		...
		<div style="width: 960px; padding:0px 2px 10px 0px;float:left;">
			<div style="width: 960px;height:140px;float:left;border:1px solid #000;">
				...
				<div style="float:left;width:240px;height:120px;padding:12px;">
					<h1 style="color:#4CAED8;font-size:22px;padding:0px;margin:0px;line-height:24px;"><?php echo $user ?></h1>
					<h3 style="color:#4CAED8;font-size:16px;padding:0px;margin:0px;line-height:24px;display:inline-block;">Status: <?php echo $status ?></h3><input style="display:inline-block;" type="text" name="status" value=""/>
