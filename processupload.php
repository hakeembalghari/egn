...
if(isset($_POST))
{
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		...
		echo '</tr>';
		echo '</table>';*/
		echo '<img style="float:left;padding:10px 5px 0px 10px;" src="uploads/'.$ThumbPrefix.$NewImageName.'" width="100" height="100" alt=""/><img id="opt_edit_pic" src="img/pencil.png" alt="" width="40" height="40" style="position:absolute;top:77px;left:77px;z-index:1000;cursor:pointer"/>';
		
		mysqli_query($con,"UPDATE users_profile SET avatar ='uploads/".$ThumbPrefix.$NewImageName."' WHERE user_id='".$_SESSION['user']['id']."'");
